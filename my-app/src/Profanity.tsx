...
const Profanity = (): JSX.Element => {
    ...
    const handleDownload = async (html: boolean, img: boolean, e: { preventDefault: () => void; }): Promise<void> => {
        ...
        try {
            const response: Response = await fetch('http://192.168.10.101:3700/api/profanity-download', {
                method: 'POST',
    ...
    const handleSubmit = async (e: { preventDefault: () => void; }): Promise<void> => {
        ...
        try {
            const response: Response = await fetch('http://192.168.10.101:3700/api/link-validity', {
                method: 'POST',
                headers: {
        ...
        try {
            const response: Response = await fetch('http://192.168.10.101:3700/api/website-link', {
                method: 'POST',
                headers: {
                    "Content-Type": "application/json"
                },
